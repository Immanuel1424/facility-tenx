...
let RolePermission = class RolePermission extends tenant_base_entity_1.TenantBaseEntity {
};
...
exports.RolePermission = RolePermission = __decorate([
    ...
    (0, typeorm_1.Unique)(['companyId', 'roleId', 'permissionId']),
    (0, typeorm_1.Index)(['companyId', 'roleId']),
    (0, typeorm_1.Index)(['companyId', 'permissionId'])
], RolePermission);
