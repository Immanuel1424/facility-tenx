...
let Notification = class Notification extends tenant_base_entity_1.TenantBaseEntity {
};
...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: notification_severity_enum_1.NotificationSeverity, default: notification_severity_enum_1.NotificationSeverity.INFO }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: notification_channel_enum_1.NotificationChannel, array: true }),
...
exports.Notification = Notification = __decorate([
    ...
    (0, typeorm_1.Index)(['companyId', 'recipientUserId', 'createdAt'])
], Notification);
