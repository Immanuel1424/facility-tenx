...
class SiteCoordinatorDashboardPage extends StatefulWidget {
  const SiteCoordinatorDashboardPage({super.key});

  @override
  State<SiteCoordinatorDashboardPage> createState() =>
      _SiteCoordinatorDashboardPageState();
}

class _SiteCoordinatorDashboardPageState
    extends State<SiteCoordinatorDashboardPage> {
                    ...
                    Expanded(
                      child: BlocBuilder<DashboardBloc, DashboardState>(
                        builder: (context, state) {
                          ...
                          if (state is DashboardLoaded) {
                            return _SiteCoordinatorDashboardLayout(
                              stats: state.stats,
                              analytics: state.analytics,
                              onRefresh: refreshCallback,
                              selectedPeriod: _selectedPeriod,
...
class _SiteCoordinatorDashboardLayout extends StatelessWidget {
  const _SiteCoordinatorDashboardLayout({
    required this.stats,
    this.analytics,
    this.onRefresh,
    required this.selectedPeriod,
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AuthBloc, AuthState>(
      builder: (context, authState) {
        ...
        final firstName = user?.firstName ?? 'Coordinator';
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  'Site Coordinator Dashboard - Manage all site tickets',
